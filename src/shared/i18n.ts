...
const messages: Record<Lang, Record<string, string>> = {
  ko: {
    ...
    'total.input': '입력',
    'total.output': '출력',
    'total.cacheWrite': '캐시 저장',
    'total.cacheRead': '캐시 읽기',
    'total.sum': '합계',
    'total.since': '{0}부터',
    'total.partial': '로그 보존 기간만 집계 (전체 아님)',
    'total.thisMachine': '이 PC의 로컬 기록 기준',
  ...
  en: {
    ...
    'total.title': 'Total tokens',
    'total.input': 'Input',
    'total.output': 'Output',
    'total.cacheWrite': 'Cache write',
    'total.cacheRead': 'Cache read',
    'total.sum': 'Total',
    'total.since': 'since {0}',
    'total.partial': 'Only what the log retains (not all-time)',
    'total.thisMachine': 'From local logs on this machine',
