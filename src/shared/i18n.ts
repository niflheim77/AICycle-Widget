...
const messages: Record<Lang, Record<string, string>> = {
  ko: {
    ...
    'btn.back': '뒤로',
    'settings.compactWeekly': '컴팩트에 주간(7D) 표시',
    'compact.collapse': '컴팩트 모드',
    'compact.expand': '일반 모드',
  ...
  en: {
    ...
    'btn.back': 'Back',
    'settings.compactWeekly': 'Weekly (7D) in compact',
    'compact.collapse': 'Compact mode',
    'compact.expand': 'Normal mode',
