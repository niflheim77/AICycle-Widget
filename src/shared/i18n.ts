...
const messages: Record<Lang, Record<string, string>> = {
  ko: {
    ...
    'settings.grokLogout': 'Grok 로그아웃',
    'settings.quit': '종료',
    // claude notes
    'w.grok': 'Grok',
    'grok.loginPrompt': 'grok.com에 로그인하면 사용량(%)이 표시됩니다',
    'grok.sessionExpired': 'grok.com 세션 만료 — 다시 로그인하세요',
    'grok.model': '모델: {0}',
    'grok.queries': '사용한 쿼리: {0}',
  ...
  en: {
    ...
    'settings.grokLogout': 'Log out of Grok',
    'settings.quit': 'Quit',
    'w.grok': 'Grok',
    'grok.loginPrompt': 'Log in to grok.com to see usage (%)',
    'grok.sessionExpired': 'grok.com session expired — log in again',
    'grok.model': 'Model: {0}',
    'grok.queries': 'Queries used: {0}',
