...
const messages: Record<Lang, Record<string, string>> = {
  ko: {
    ...
    'btn.back': '뒤로',
    'density.toCompact': '컴팩트 모드로',
    'density.toSuper': '슈퍼 컴팩트로',
    'density.toNormal': '일반 모드로',
    'compact.login': '로그인 필요',
    'compact.noData': '데이터 없음',
    'state.loading': '로딩…',
    'state.noData': '데이터 없음',
  ...
  en: {
    ...
    'btn.back': 'Back',
    'density.toCompact': 'Switch to compact',
    'density.toSuper': 'Switch to super compact',
    'density.toNormal': 'Switch to normal',
    'compact.login': 'Log in',
    'compact.noData': 'No data',
